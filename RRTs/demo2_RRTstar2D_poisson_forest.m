%demo2: RRT* planning in 2D environment with poisson forest
addpath(genpath("../"));
clc;
clear;
close all;
...
gamma = 0.5; %rewire radius constant based on environment
...
maxIter = 800;
%create planner
myRRT = RRTstar_Planner(start, goal, extendLen, goalCheckProb, gamma, sampleRange, calDisFcn, collisDetectFcn);
